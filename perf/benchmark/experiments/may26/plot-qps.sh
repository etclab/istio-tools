...
# modes=mazu_240s_ka_true_both,no_istio_240s_ka_true_no_istio,istio_mtls_240s_ka_true_both,istio_plaintext_240s_ka_true_both
...
python graph_plotter/graph_plotter.py --graph_type=latency-p99 --x_axis=qps --telemetry_modes=mazu_240s_ka_true_both,no_istio_240s_ka_true_no_istio,istio_mtls_240s_ka_true_both,istio_plaintext_240s_ka_true_both --query_list=1000,2000,4000,8000,16000,24000,32000 --query_str=NumThreads==64 --csv_filepath=$SCRIPT_DIR/sorted_data.csv.dat --graph_title=$SCRIPT_DIR/latency-p99-240s.png
