...
python graph_plotter/graph_plotter.py --graph_type=latency-p90 --x_axis=conn --telemetry_modes=mazu_240s_ka_true_unc_true_both,istio_mtls_240s_w_unset_both,no_istio_240s_w_unset_no_istio,istio_plaintext_240s_w_unset_both --query_list=2,4,8,16,32,64,128,256 --query_str=ActualQPS==1000 --csv_filepath=experiments/data/workers_unset/sorted_data.csv --graph_title=experiments/plots/new/latency-p90-full.png

python graph_plotter/graph_plotter.py --graph_type=latency-p99 --x_axis=conn --telemetry_modes=mazu_240s_ka_true_unc_true_both,istio_mtls_240s_w_unset_both,no_istio_240s_w_unset_no_istio,istio_plaintext_240s_w_unset_both --query_list=2,4,8,16,32,64,128,256 --query_str=ActualQPS==1000 --csv_filepath=experiments/data/workers_unset/sorted_data.csv --graph_title=experiments/plots/new/latency-p99-full.png

python graph_plotter/graph_plotter.py --graph_type=latency-p999 --x_axis=conn --telemetry_modes=mazu_240s_ka_true_unc_true_both,istio_mtls_240s_w_unset_both,no_istio_240s_w_unset_no_istio,istio_plaintext_240s_w_unset_both --query_list=2,4,8,16,32,64,128,256 --query_str=ActualQPS==1000 --csv_filepath=experiments/data/workers_unset/sorted_data.csv --graph_title=experiments/plots/new/latency-p999-full.png

# ignore the first three records
python graph_plotter/graph_plotter.py --graph_type=latency-p90 --x_axis=conn --telemetry_modes=mazu_240s_ka_true_unc_true_both,istio_mtls_240s_w_unset_both,no_istio_240s_w_unset_no_istio,istio_plaintext_240s_w_unset_both --query_list=32,64,128,256 --query_str=ActualQPS==1000 --csv_filepath=experiments/data/workers_unset/sorted_data.csv --graph_title=experiments/plots/new/latency-p90.png

python graph_plotter/graph_plotter.py --graph_type=latency-p99 --x_axis=conn --telemetry_modes=mazu_240s_ka_true_unc_true_both,istio_mtls_240s_w_unset_both,no_istio_240s_w_unset_no_istio,istio_plaintext_240s_w_unset_both --query_list=32,64,128,256 --query_str=ActualQPS==1000 --csv_filepath=experiments/data/workers_unset/sorted_data.csv --graph_title=experiments/plots/new/latency-p99.png

python graph_plotter/graph_plotter.py --graph_type=latency-p999 --x_axis=conn --telemetry_modes=mazu_240s_ka_true_unc_true_both,istio_mtls_240s_w_unset_both,no_istio_240s_w_unset_no_istio,istio_plaintext_240s_w_unset_both --query_list=32,64,128,256 --query_str=ActualQPS==1000 --csv_filepath=experiments/data/workers_unset/sorted_data.csv --graph_title=experiments/plots/new/latency-p999.png